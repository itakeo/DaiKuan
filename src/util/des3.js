...
var des3iv = '12345678';
var key = 'youLOAN2018siese.jiuhyHYU.Ui@cc1@cc10@.COM.1088';
...
function des3_encrypt(){
        ...
        input = base64encode(des(genKey.key, input, 1, 0, des3iv, 1));
		return input;
}
...
function des3_decrypt(){
    ...
    return des(genKey.key, base64decode(input), 0, 0, des3iv, 1); 
}
export default des3_encrypt
// module.exports = {
